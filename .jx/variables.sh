...
export JENKINS_X_URL='https://dashboard-jx.dev.jenkins-x.me/jenkins-x-charts/grafana-dashboard/master/2'
...
export MINK_IMAGE='ghcr.io/jenkins-x/grafana-dashboard:0.2.2'
